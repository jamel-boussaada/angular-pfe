...
private notfifcationService:  NotificationService,
    ...
    {
        this.decryptNotification();
        return this.notifications$.pipe(
            take(1),
            switchMap(notifications => this._httpClient.post<Notification>('http://127.0.0.1:8000/notification', {notification}).pipe(
                map((newNotification) => {
...
//       this.notfifcationService.getNotification().subscribe((newNotification) =>{
// console.log(newNotification);
...
{
    this.decryptNotification();
    return this._httpClient.post<Notification[]>('http://127.0.0.1:8000/notification','').pipe(
        tap((notifications) => {
