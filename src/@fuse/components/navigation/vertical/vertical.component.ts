...
export class FuseVerticalNavigationComponent implements OnChanges, OnInit, AfterViewInit, OnDestroy
{
    ...
    id: string | null = null;
    activeAsideItemId1Base: string | null = null;
...
// alert(changes);
    ...
    //    alert(this._fuseNavigationService.registerComponent(this.name, this));
        ...
        this._router.events
            ...
            .subscribe(() => {
                //  alert(event => event instanceof navigation);
    ...
    private _hideOverlay(): void
    {
        ...
        this._player.onDone(() => {
            ...
            // If the overlay still exists...
            {
                ...
                //  alert(     this._fuseNavigationService.getItem('2',this.navigation));
